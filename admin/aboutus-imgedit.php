...
{	
	...
	// unlink($file_name_old);
		...
		//updating the table
		$result = mysqli_query($mysqli, " UPDATE uploading SET image='$file_destination' WHERE id=$id");
...
$id = $_GET['id'];
$result = mysqli_query($mysqli, "SELECT * FROM uploading WHERE id=$id");
...
<body>
	...
	<form name="form1" method="post" action="aboutus-imgedit.php" enctype="multipart/form-data">
		<table border="0">
			<tr> 
				<td>image</td>
