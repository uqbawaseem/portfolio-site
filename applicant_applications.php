...
<table  id="dtDynamicVerticalScrollExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" >
            ...
            $name = $_SESSION['name'];
               ...
               $result = mysqli_query($connection, "SELECT * FROM apply WHERE `applicant_name`='$name'");
                  while($p = mysqli_fetch_array($result)){
                      ...
                      echo "<td><a href=\"appliccation_edit.php?id=$p[applicant_id]\" class= \"btn btn-secondary\"><i class=\"fa fa-edit\"></i></a> <br><br> <a href=\"application_delete.php?id=$p[applicant_id]\"  class= \"btn btn-danger\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class=\"fa fa-trash\" style=\"color:red;\"></i></a></td>";		         
                  }
                  ?>
            </td>
            </tr>
